...
// import x from "./assets/images/booksImg/AddyOsmani.jpg"
...
// add book item
bookItem.innerHTML = `<img class="card-item-img" src="${booksData[0].imageLink}"/>
<div class="card-item-content-wrapper">
<h3 class="book-author">${booksData[0].author}</h3>
<p class="book-title">${booksData[0].title}</p>
<p class="book-price">Price: $${booksData[0].price}</p>
...
addBtns.forEach((element) => {
  element.addEventListener("click", () => {
    ...
    orderItem.querySelector(".order-item-btn-close").addEventListener("click", (e) => {
